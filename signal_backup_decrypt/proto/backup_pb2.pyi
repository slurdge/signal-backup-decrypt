...
class BackupInfo(_message.Message):
    __slots__ = ("version", "backupTimeMs", "mediaRootBackupKey", "currentAppVersion", "firstAppVersion", "debugInfo")
    ...
    firstAppVersion: str
    debugInfo: bytes
    def __init__(self, version: _Optional[int] = ..., backupTimeMs: _Optional[int] = ..., mediaRootBackupKey: _Optional[bytes] = ..., currentAppVersion: _Optional[str] = ..., firstAppVersion: _Optional[str] = ..., debugInfo: _Optional[bytes] = ...) -> None: ...
...
class AccountData(_message.Message):
    __slots__ = ("profileKey", "username", "usernameLink", "givenName", "familyName", "avatarUrlPath", "donationSubscriberData", "accountSettings", "backupsSubscriberData", "svrPin", "androidSpecificSettings", "bioText", "bioEmoji", "iosSpecificSettings")
    ...
    class SentMediaQuality(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNKNOWN_QUALITY: _ClassVar[AccountData.SentMediaQuality]
        STANDARD: _ClassVar[AccountData.SentMediaQuality]
        HIGH: _ClassVar[AccountData.SentMediaQuality]
    UNKNOWN_QUALITY: AccountData.SentMediaQuality
    STANDARD: AccountData.SentMediaQuality
    HIGH: AccountData.SentMediaQuality
    class AppTheme(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNKNOWN_APP_THEME: _ClassVar[AccountData.AppTheme]
        SYSTEM: _ClassVar[AccountData.AppTheme]
        LIGHT: _ClassVar[AccountData.AppTheme]
        DARK: _ClassVar[AccountData.AppTheme]
    UNKNOWN_APP_THEME: AccountData.AppTheme
    SYSTEM: AccountData.AppTheme
    LIGHT: AccountData.AppTheme
    DARK: AccountData.AppTheme
    class CallsUseLessDataSetting(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNKNOWN_CALL_DATA_SETTING: _ClassVar[AccountData.CallsUseLessDataSetting]
        NEVER: _ClassVar[AccountData.CallsUseLessDataSetting]
        MOBILE_DATA_ONLY: _ClassVar[AccountData.CallsUseLessDataSetting]
        WIFI_AND_MOBILE_DATA: _ClassVar[AccountData.CallsUseLessDataSetting]
    UNKNOWN_CALL_DATA_SETTING: AccountData.CallsUseLessDataSetting
    NEVER: AccountData.CallsUseLessDataSetting
    MOBILE_DATA_ONLY: AccountData.CallsUseLessDataSetting
    WIFI_AND_MOBILE_DATA: AccountData.CallsUseLessDataSetting
    ...
    class AutoDownloadSettings(_message.Message):
        __slots__ = ("images", "audio", "video", "documents")
        class AutoDownloadOption(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            UNKNOWN: _ClassVar[AccountData.AutoDownloadSettings.AutoDownloadOption]
            NEVER: _ClassVar[AccountData.AutoDownloadSettings.AutoDownloadOption]
            WIFI: _ClassVar[AccountData.AutoDownloadSettings.AutoDownloadOption]
            WIFI_AND_CELLULAR: _ClassVar[AccountData.AutoDownloadSettings.AutoDownloadOption]
        UNKNOWN: AccountData.AutoDownloadSettings.AutoDownloadOption
        NEVER: AccountData.AutoDownloadSettings.AutoDownloadOption
        WIFI: AccountData.AutoDownloadSettings.AutoDownloadOption
        WIFI_AND_CELLULAR: AccountData.AutoDownloadSettings.AutoDownloadOption
        IMAGES_FIELD_NUMBER: _ClassVar[int]
        AUDIO_FIELD_NUMBER: _ClassVar[int]
        VIDEO_FIELD_NUMBER: _ClassVar[int]
        DOCUMENTS_FIELD_NUMBER: _ClassVar[int]
        images: AccountData.AutoDownloadSettings.AutoDownloadOption
        audio: AccountData.AutoDownloadSettings.AutoDownloadOption
        video: AccountData.AutoDownloadSettings.AutoDownloadOption
        documents: AccountData.AutoDownloadSettings.AutoDownloadOption
        def __init__(self, images: _Optional[_Union[AccountData.AutoDownloadSettings.AutoDownloadOption, str]] = ..., audio: _Optional[_Union[AccountData.AutoDownloadSettings.AutoDownloadOption, str]] = ..., video: _Optional[_Union[AccountData.AutoDownloadSettings.AutoDownloadOption, str]] = ..., documents: _Optional[_Union[AccountData.AutoDownloadSettings.AutoDownloadOption, str]] = ...) -> None: ...
    class AccountSettings(_message.Message):
        __slots__ = ("readReceipts", "sealedSenderIndicators", "typingIndicators", "linkPreviews", "notDiscoverableByPhoneNumber", "preferContactAvatars", "universalExpireTimerSeconds", "preferredReactionEmoji", "displayBadgesOnProfile", "keepMutedChatsArchived", "hasSetMyStoriesPrivacy", "hasViewedOnboardingStory", "storiesDisabled", "storyViewReceiptsEnabled", "hasSeenGroupStoryEducationSheet", "hasCompletedUsernameOnboarding", "phoneNumberSharingMode", "defaultChatStyle", "customChatColors", "optimizeOnDeviceStorage", "backupTier", "defaultSentMediaQuality", "autoDownloadSettings", "screenLockTimeoutMinutes", "pinReminders", "appTheme", "callsUseLessDataSetting", "allowSealedSenderFromAnyone", "allowAutomaticKeyVerification", "hasSeenAdminDeleteEducationDialog")
        ...
        DEFAULTSENTMEDIAQUALITY_FIELD_NUMBER: _ClassVar[int]
        AUTODOWNLOADSETTINGS_FIELD_NUMBER: _ClassVar[int]
        SCREENLOCKTIMEOUTMINUTES_FIELD_NUMBER: _ClassVar[int]
        PINREMINDERS_FIELD_NUMBER: _ClassVar[int]
        APPTHEME_FIELD_NUMBER: _ClassVar[int]
        CALLSUSELESSDATASETTING_FIELD_NUMBER: _ClassVar[int]
        ALLOWSEALEDSENDERFROMANYONE_FIELD_NUMBER: _ClassVar[int]
        ALLOWAUTOMATICKEYVERIFICATION_FIELD_NUMBER: _ClassVar[int]
        HASSEENADMINDELETEEDUCATIONDIALOG_FIELD_NUMBER: _ClassVar[int]
        readReceipts: bool
        ...
        backupTier: int
        defaultSentMediaQuality: AccountData.SentMediaQuality
        autoDownloadSettings: AccountData.AutoDownloadSettings
        screenLockTimeoutMinutes: int
        pinReminders: bool
        appTheme: AccountData.AppTheme
        callsUseLessDataSetting: AccountData.CallsUseLessDataSetting
        allowSealedSenderFromAnyone: bool
        allowAutomaticKeyVerification: bool
        hasSeenAdminDeleteEducationDialog: bool
        def __init__(self, readReceipts: _Optional[bool] = ..., sealedSenderIndicators: _Optional[bool] = ..., typingIndicators: _Optional[bool] = ..., linkPreviews: _Optional[bool] = ..., notDiscoverableByPhoneNumber: _Optional[bool] = ..., preferContactAvatars: _Optional[bool] = ..., universalExpireTimerSeconds: _Optional[int] = ..., preferredReactionEmoji: _Optional[_Iterable[str]] = ..., displayBadgesOnProfile: _Optional[bool] = ..., keepMutedChatsArchived: _Optional[bool] = ..., hasSetMyStoriesPrivacy: _Optional[bool] = ..., hasViewedOnboardingStory: _Optional[bool] = ..., storiesDisabled: _Optional[bool] = ..., storyViewReceiptsEnabled: _Optional[bool] = ..., hasSeenGroupStoryEducationSheet: _Optional[bool] = ..., hasCompletedUsernameOnboarding: _Optional[bool] = ..., phoneNumberSharingMode: _Optional[_Union[AccountData.PhoneNumberSharingMode, str]] = ..., defaultChatStyle: _Optional[_Union[ChatStyle, _Mapping]] = ..., customChatColors: _Optional[_Iterable[_Union[ChatStyle.CustomChatColor, _Mapping]]] = ..., optimizeOnDeviceStorage: _Optional[bool] = ..., backupTier: _Optional[int] = ..., defaultSentMediaQuality: _Optional[_Union[AccountData.SentMediaQuality, str]] = ..., autoDownloadSettings: _Optional[_Union[AccountData.AutoDownloadSettings, _Mapping]] = ..., screenLockTimeoutMinutes: _Optional[int] = ..., pinReminders: _Optional[bool] = ..., appTheme: _Optional[_Union[AccountData.AppTheme, str]] = ..., callsUseLessDataSetting: _Optional[_Union[AccountData.CallsUseLessDataSetting, str]] = ..., allowSealedSenderFromAnyone: _Optional[bool] = ..., allowAutomaticKeyVerification: _Optional[bool] = ..., hasSeenAdminDeleteEducationDialog: _Optional[bool] = ...) -> None: ...
    class SubscriberData(_message.Message):
        ...
        def __init__(self, subscriberId: _Optional[bytes] = ..., currencyCode: _Optional[str] = ..., manuallyCancelled: _Optional[bool] = ...) -> None: ...
    ...
    class AndroidSpecificSettings(_message.Message):
        __slots__ = ("useSystemEmoji", "screenshotSecurity", "navigationBarSize")
        class NavigationBarSize(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            UNKNOWN_BAR_SIZE: _ClassVar[AccountData.AndroidSpecificSettings.NavigationBarSize]
            NORMAL: _ClassVar[AccountData.AndroidSpecificSettings.NavigationBarSize]
            COMPACT: _ClassVar[AccountData.AndroidSpecificSettings.NavigationBarSize]
        UNKNOWN_BAR_SIZE: AccountData.AndroidSpecificSettings.NavigationBarSize
        NORMAL: AccountData.AndroidSpecificSettings.NavigationBarSize
        COMPACT: AccountData.AndroidSpecificSettings.NavigationBarSize
        USESYSTEMEMOJI_FIELD_NUMBER: _ClassVar[int]
        SCREENSHOTSECURITY_FIELD_NUMBER: _ClassVar[int]
        NAVIGATIONBARSIZE_FIELD_NUMBER: _ClassVar[int]
        useSystemEmoji: bool
        screenshotSecurity: bool
        navigationBarSize: AccountData.AndroidSpecificSettings.NavigationBarSize
        def __init__(self, useSystemEmoji: _Optional[bool] = ..., screenshotSecurity: _Optional[bool] = ..., navigationBarSize: _Optional[_Union[AccountData.AndroidSpecificSettings.NavigationBarSize, str]] = ...) -> None: ...
    class IOSSpecificSettings(_message.Message):
        __slots__ = ("isSystemCallLogEnabled",)
        ISSYSTEMCALLLOGENABLED_FIELD_NUMBER: _ClassVar[int]
        isSystemCallLogEnabled: bool
        def __init__(self, isSystemCallLogEnabled: _Optional[bool] = ...) -> None: ...
    ...
    ANDROIDSPECIFICSETTINGS_FIELD_NUMBER: _ClassVar[int]
    BIOTEXT_FIELD_NUMBER: _ClassVar[int]
    BIOEMOJI_FIELD_NUMBER: _ClassVar[int]
    IOSSPECIFICSETTINGS_FIELD_NUMBER: _ClassVar[int]
    profileKey: bytes
    username: str
    ...
    bioText: str
    bioEmoji: str
    iosSpecificSettings: AccountData.IOSSpecificSettings
    def __init__(self, profileKey: _Optional[bytes] = ..., username: _Optional[str] = ..., usernameLink: _Optional[_Union[AccountData.UsernameLink, _Mapping]] = ..., givenName: _Optional[str] = ..., familyName: _Optional[str] = ..., avatarUrlPath: _Optional[str] = ..., donationSubscriberData: _Optional[_Union[AccountData.SubscriberData, _Mapping]] = ..., accountSettings: _Optional[_Union[AccountData.AccountSettings, _Mapping]] = ..., backupsSubscriberData: _Optional[_Union[AccountData.IAPSubscriberData, _Mapping]] = ..., svrPin: _Optional[str] = ..., androidSpecificSettings: _Optional[_Union[AccountData.AndroidSpecificSettings, _Mapping]] = ..., bioText: _Optional[str] = ..., bioEmoji: _Optional[str] = ..., iosSpecificSettings: _Optional[_Union[AccountData.IOSSpecificSettings, _Mapping]] = ...) -> None: ...
...
class Recipient(_message.Message):
    ...
    callLink: CallLink
    def __init__(self_, id: _Optional[int] = ..., contact: _Optional[_Union[Contact, _Mapping]] = ..., group: _Optional[_Union[Group, _Mapping]] = ..., distributionList: _Optional[_Union[DistributionListItem, _Mapping]] = ..., self: _Optional[_Union[Self, _Mapping]] = ..., releaseNotes: _Optional[_Union[ReleaseNotes, _Mapping]] = ..., callLink: _Optional[_Union[CallLink, _Mapping]] = ...) -> None: ...

class Contact(_message.Message):
    __slots__ = ("aci", "pni", "username", "e164", "blocked", "visibility", "registered", "notRegistered", "profileKey", "profileSharing", "profileGivenName", "profileFamilyName", "hideStory", "identityKey", "identityState", "nickname", "note", "systemGivenName", "systemFamilyName", "systemNickname", "avatarColor", "keyTransparencyData")
    ...
    KEYTRANSPARENCYDATA_FIELD_NUMBER: _ClassVar[int]
    aci: bytes
    pni: bytes
    username: str
    e164: int
    ...
    keyTransparencyData: bytes
    def __init__(self, aci: _Optional[bytes] = ..., pni: _Optional[bytes] = ..., username: _Optional[str] = ..., e164: _Optional[int] = ..., blocked: _Optional[bool] = ..., visibility: _Optional[_Union[Contact.Visibility, str]] = ..., registered: _Optional[_Union[Contact.Registered, _Mapping]] = ..., notRegistered: _Optional[_Union[Contact.NotRegistered, _Mapping]] = ..., profileKey: _Optional[bytes] = ..., profileSharing: _Optional[bool] = ..., profileGivenName: _Optional[str] = ..., profileFamilyName: _Optional[str] = ..., hideStory: _Optional[bool] = ..., identityKey: _Optional[bytes] = ..., identityState: _Optional[_Union[Contact.IdentityState, str]] = ..., nickname: _Optional[_Union[Contact.Name, _Mapping]] = ..., note: _Optional[str] = ..., systemGivenName: _Optional[str] = ..., systemFamilyName: _Optional[str] = ..., systemNickname: _Optional[str] = ..., avatarColor: _Optional[_Union[AvatarColor, str]] = ..., keyTransparencyData: _Optional[bytes] = ...) -> None: ...
...
class Group(_message.Message):
    ...
    class GroupSnapshot(_message.Message):
        __slots__ = ("title", "description", "avatarUrl", "disappearingMessagesTimer", "accessControl", "version", "members", "membersPendingProfileKey", "membersPendingAdminApproval", "inviteLinkPassword", "announcementsOnly", "membersBanned", "terminated")
        ...
        MEMBERSBANNED_FIELD_NUMBER: _ClassVar[int]
    ...
    class Member(_message.Message):
        __slots__ = ("userId", "role", "joinedAtVersion", "labelEmoji", "labelString")
        ...
        LABELEMOJI_FIELD_NUMBER: _ClassVar[int]
        LABELSTRING_FIELD_NUMBER: _ClassVar[int]
        userId: bytes
        role: Group.Member.Role
        joinedAtVersion: int
        labelEmoji: str
        labelString: str
        def __init__(self, userId: _Optional[bytes] = ..., role: _Optional[_Union[Group.Member.Role, str]] = ..., joinedAtVersion: _Optional[int] = ..., labelEmoji: _Optional[str] = ..., labelString: _Optional[str] = ...) -> None: ...
    ...
    class AccessControl(_message.Message):
        __slots__ = ("attributes", "members", "addFromInviteLink", "memberLabel")
        ...
        memberLabel: Group.AccessControl.AccessRequired
        def __init__(self, attributes: _Optional[_Union[Group.AccessControl.AccessRequired, str]] = ..., members: _Optional[_Union[Group.AccessControl.AccessRequired, str]] = ..., addFromInviteLink: _Optional[_Union[Group.AccessControl.AccessRequired, str]] = ..., memberLabel: _Optional[_Union[Group.AccessControl.AccessRequired, str]] = ...) -> None: ...
    ...
    blocked: bool
    avatarColor: AvatarColor
    def __init__(self, masterKey: _Optional[bytes] = ..., whitelisted: _Optional[bool] = ..., hideStory: _Optional[bool] = ..., storySendMode: _Optional[_Union[Group.StorySendMode, str]] = ..., snapshot: _Optional[_Union[Group.GroupSnapshot, _Mapping]] = ..., blocked: _Optional[bool] = ..., avatarColor: _Optional[_Union[AvatarColor, str]] = ...) -> None: ...
...
class Chat(_message.Message):
    ...
    def __init__(self, id: _Optional[int] = ..., recipientId: _Optional[int] = ..., archived: _Optional[bool] = ..., pinnedOrder: _Optional[int] = ..., expirationTimerMs: _Optional[int] = ..., muteUntilMs: _Optional[int] = ..., markedUnread: _Optional[bool] = ..., dontNotifyForMentionsIfMuted: _Optional[bool] = ..., style: _Optional[_Union[ChatStyle, _Mapping]] = ..., expireTimerVersion: _Optional[int] = ...) -> None: ...
...
class DistributionList(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., allowReplies: _Optional[bool] = ..., privacyMode: _Optional[_Union[DistributionList.PrivacyMode, str]] = ..., memberRecipientIds: _Optional[_Iterable[int]] = ...) -> None: ...

class ChatItem(_message.Message):
    __slots__ = ("chatId", "authorId", "dateSent", "expireStartDate", "expiresInMs", "revisions", "sms", "incoming", "outgoing", "directionless", "standardMessage", "contactMessage", "stickerMessage", "remoteDeletedMessage", "updateMessage", "paymentNotification", "giftBadge", "viewOnceMessage", "directStoryReplyMessage", "poll", "adminDeletedMessage", "pinDetails")
    class IncomingMessageDetails(_message.Message):
        ...
        read: bool
        sealedSender: bool
        def __init__(self, dateReceived: _Optional[int] = ..., dateServerSent: _Optional[int] = ..., read: _Optional[bool] = ..., sealedSender: _Optional[bool] = ...) -> None: ...
    class OutgoingMessageDetails(_message.Message):
        __slots__ = ("sendStatus", "dateReceived")
        SENDSTATUS_FIELD_NUMBER: _ClassVar[int]
        DATERECEIVED_FIELD_NUMBER: _ClassVar[int]
        sendStatus: _containers.RepeatedCompositeFieldContainer[SendStatus]
        dateReceived: int
        def __init__(self, sendStatus: _Optional[_Iterable[_Union[SendStatus, _Mapping]]] = ..., dateReceived: _Optional[int] = ...) -> None: ...
    class DirectionlessMessageDetails(_message.Message):
        __slots__ = ()
        def __init__(self) -> None: ...
    class PinDetails(_message.Message):
        __slots__ = ("pinnedAtTimestamp", "pinExpiresAtTimestamp", "pinNeverExpires")
        PINNEDATTIMESTAMP_FIELD_NUMBER: _ClassVar[int]
        PINEXPIRESATTIMESTAMP_FIELD_NUMBER: _ClassVar[int]
        PINNEVEREXPIRES_FIELD_NUMBER: _ClassVar[int]
        pinnedAtTimestamp: int
        pinExpiresAtTimestamp: int
        pinNeverExpires: bool
        def __init__(self, pinnedAtTimestamp: _Optional[int] = ..., pinExpiresAtTimestamp: _Optional[int] = ..., pinNeverExpires: _Optional[bool] = ...) -> None: ...
    ...
    ADMINDELETEDMESSAGE_FIELD_NUMBER: _ClassVar[int]
    PINDETAILS_FIELD_NUMBER: _ClassVar[int]
    chatId: int
    authorId: int
    dateSent: int
    expireStartDate: int
    ...
    def __init__(self, chatId: _Optional[int] = ..., authorId: _Optional[int] = ..., dateSent: _Optional[int] = ..., expireStartDate: _Optional[int] = ..., expiresInMs: _Optional[int] = ..., revisions: _Optional[_Iterable[_Union[ChatItem, _Mapping]]] = ..., sms: _Optional[bool] = ..., incoming: _Optional[_Union[ChatItem.IncomingMessageDetails, _Mapping]] = ..., outgoing: _Optional[_Union[ChatItem.OutgoingMessageDetails, _Mapping]] = ..., directionless: _Optional[_Union[ChatItem.DirectionlessMessageDetails, _Mapping]] = ..., standardMessage: _Optional[_Union[StandardMessage, _Mapping]] = ..., contactMessage: _Optional[_Union[ContactMessage, _Mapping]] = ..., stickerMessage: _Optional[_Union[StickerMessage, _Mapping]] = ..., remoteDeletedMessage: _Optional[_Union[RemoteDeletedMessage, _Mapping]] = ..., updateMessage: _Optional[_Union[ChatUpdateMessage, _Mapping]] = ..., paymentNotification: _Optional[_Union[PaymentNotification, _Mapping]] = ..., giftBadge: _Optional[_Union[GiftBadge, _Mapping]] = ..., viewOnceMessage: _Optional[_Union[ViewOnceMessage, _Mapping]] = ..., directStoryReplyMessage: _Optional[_Union[DirectStoryReplyMessage, _Mapping]] = ..., poll: _Optional[_Union[Poll, _Mapping]] = ..., adminDeletedMessage: _Optional[_Union[AdminDeletedMessage, _Mapping]] = ..., pinDetails: _Optional[_Union[ChatItem.PinDetails, _Mapping]] = ...) -> None: ...
...
class SendStatus(_message.Message):
    ...
    class Sent(_message.Message):
        ...
        SEALEDSENDER_FIELD_NUMBER: _ClassVar[int]
        sealedSender: bool
        def __init__(self, sealedSender: _Optional[bool] = ...) -> None: ...
...
class MessageAttachment(_message.Message):
    ...
    wasDownloaded: bool
    clientUuid: bytes
    def __init__(self, pointer: _Optional[_Union[FilePointer, _Mapping]] = ..., flag: _Optional[_Union[MessageAttachment.Flag, str]] = ..., wasDownloaded: _Optional[bool] = ..., clientUuid: _Optional[bytes] = ...) -> None: ...

class FilePointer(_message.Message):
    __slots__ = ("contentType", "incrementalMac", "incrementalMacChunkSize", "fileName", "width", "height", "caption", "blurHash", "locatorInfo")
    class LocatorInfo(_message.Message):
        __slots__ = ("key", "plaintextHash", "encryptedDigest", "size", "transitCdnKey", "transitCdnNumber", "transitTierUploadTimestamp", "mediaTierCdnNumber", "localKey")
        ...
        localKey: bytes
        def __init__(self, key: _Optional[bytes] = ..., plaintextHash: _Optional[bytes] = ..., encryptedDigest: _Optional[bytes] = ..., size: _Optional[int] = ..., transitCdnKey: _Optional[str] = ..., transitCdnNumber: _Optional[int] = ..., transitTierUploadTimestamp: _Optional[int] = ..., mediaTierCdnNumber: _Optional[int] = ..., localKey: _Optional[bytes] = ...) -> None: ...
    ...
    def __init__(self, contentType: _Optional[str] = ..., incrementalMac: _Optional[bytes] = ..., incrementalMacChunkSize: _Optional[int] = ..., fileName: _Optional[str] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., caption: _Optional[str] = ..., blurHash: _Optional[str] = ..., locatorInfo: _Optional[_Union[FilePointer.LocatorInfo, _Mapping]] = ...) -> None: ...
...
class Poll(_message.Message):
    __slots__ = ("question", "allowMultiple", "options", "hasEnded", "reactions")
    class PollOption(_message.Message):
        __slots__ = ("option", "votes")
        class PollVote(_message.Message):
            __slots__ = ("voterId", "voteCount")
            VOTERID_FIELD_NUMBER: _ClassVar[int]
            VOTECOUNT_FIELD_NUMBER: _ClassVar[int]
            voterId: int
            voteCount: int
            def __init__(self, voterId: _Optional[int] = ..., voteCount: _Optional[int] = ...) -> None: ...
        OPTION_FIELD_NUMBER: _ClassVar[int]
        VOTES_FIELD_NUMBER: _ClassVar[int]
        option: str
        votes: _containers.RepeatedCompositeFieldContainer[Poll.PollOption.PollVote]
        def __init__(self, option: _Optional[str] = ..., votes: _Optional[_Iterable[_Union[Poll.PollOption.PollVote, _Mapping]]] = ...) -> None: ...
    QUESTION_FIELD_NUMBER: _ClassVar[int]
    ALLOWMULTIPLE_FIELD_NUMBER: _ClassVar[int]
    OPTIONS_FIELD_NUMBER: _ClassVar[int]
    HASENDED_FIELD_NUMBER: _ClassVar[int]
    REACTIONS_FIELD_NUMBER: _ClassVar[int]
    question: str
    allowMultiple: bool
    options: _containers.RepeatedCompositeFieldContainer[Poll.PollOption]
    hasEnded: bool
    reactions: _containers.RepeatedCompositeFieldContainer[Reaction]
    def __init__(self, question: _Optional[str] = ..., allowMultiple: _Optional[bool] = ..., options: _Optional[_Iterable[_Union[Poll.PollOption, _Mapping]]] = ..., hasEnded: _Optional[bool] = ..., reactions: _Optional[_Iterable[_Union[Reaction, _Mapping]]] = ...) -> None: ...

class AdminDeletedMessage(_message.Message):
    __slots__ = ("adminId",)
    ADMINID_FIELD_NUMBER: _ClassVar[int]
    adminId: int
    def __init__(self, adminId: _Optional[int] = ...) -> None: ...

class ChatUpdateMessage(_message.Message):
    __slots__ = ("simpleUpdate", "groupChange", "expirationTimerChange", "profileChange", "threadMerge", "sessionSwitchover", "individualCall", "groupCall", "learnedProfileChange", "pollTerminate", "pinMessage")
    ...
    POLLTERMINATE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, simpleUpdate: _Optional[_Union[SimpleChatUpdate, _Mapping]] = ..., groupChange: _Optional[_Union[GroupChangeChatUpdate, _Mapping]] = ..., expirationTimerChange: _Optional[_Union[ExpirationTimerChatUpdate, _Mapping]] = ..., profileChange: _Optional[_Union[ProfileChangeChatUpdate, _Mapping]] = ..., threadMerge: _Optional[_Union[ThreadMergeChatUpdate, _Mapping]] = ..., sessionSwitchover: _Optional[_Union[SessionSwitchoverChatUpdate, _Mapping]] = ..., individualCall: _Optional[_Union[IndividualCall, _Mapping]] = ..., groupCall: _Optional[_Union[GroupCall, _Mapping]] = ..., learnedProfileChange: _Optional[_Union[LearnedProfileChatUpdate, _Mapping]] = ..., pollTerminate: _Optional[_Union[PollTerminateUpdate, _Mapping]] = ..., pinMessage: _Optional[_Union[PinMessageUpdate, _Mapping]] = ...) -> None: ...
...
class IndividualCall(_message.Message):
    ...
    read: bool
    def __init__(self, callId: _Optional[int] = ..., type: _Optional[_Union[IndividualCall.Type, str]] = ..., direction: _Optional[_Union[IndividualCall.Direction, str]] = ..., state: _Optional[_Union[IndividualCall.State, str]] = ..., startedCallTimestamp: _Optional[int] = ..., read: _Optional[bool] = ...) -> None: ...
...
class GroupCall(_message.Message):
    ...
    read: bool
    def __init__(self, callId: _Optional[int] = ..., state: _Optional[_Union[GroupCall.State, str]] = ..., ringerRecipientId: _Optional[int] = ..., startedCallRecipientId: _Optional[int] = ..., startedCallTimestamp: _Optional[int] = ..., endedCallTimestamp: _Optional[int] = ..., read: _Optional[bool] = ...) -> None: ...
...
class GroupChangeChatUpdate(_message.Message):
    ...
    class Update(_message.Message):
        ...
        GROUPMEMBERLABELACCESSLEVELCHANGEUPDATE_FIELD_NUMBER: _ClassVar[int]
        GROUPTERMINATECHANGEUPDATE_FIELD_NUMBER: _ClassVar[int]
...
class GroupAvatarUpdate(_message.Message):
    ...
    updaterAci: bytes
    wasRemoved: bool
    def __init__(self, updaterAci: _Optional[bytes] = ..., wasRemoved: _Optional[bool] = ...) -> None: ...
...
class GroupMemberLabelAccessLevelChangeUpdate(_message.Message):
    __slots__ = ("updaterAci", "accessLevel")
    UPDATERACI_FIELD_NUMBER: _ClassVar[int]
    ACCESSLEVEL_FIELD_NUMBER: _ClassVar[int]
    updaterAci: bytes
...
class GroupAnnouncementOnlyChangeUpdate(_message.Message):
    ...
    def __init__(self, updaterAci: _Optional[bytes] = ..., isAnnouncementOnly: _Optional[bool] = ...) -> None: ...
...
class GroupAdminStatusUpdate(_message.Message):
    ...
    def __init__(self, updaterAci: _Optional[bytes] = ..., memberAci: _Optional[bytes] = ..., wasAdminStatusGranted: _Optional[bool] = ...) -> None: ...
...
class GroupMemberAddedUpdate(_message.Message):
    ...
    inviterAci: bytes
    def __init__(self, updaterAci: _Optional[bytes] = ..., newMemberAci: _Optional[bytes] = ..., hadOpenInvitation: _Optional[bool] = ..., inviterAci: _Optional[bytes] = ...) -> None: ...
...
class GroupJoinRequestApprovalUpdate(_message.Message):
    ...
    updaterAci: bytes
    wasApproved: bool
    def __init__(self, requestorAci: _Optional[bytes] = ..., updaterAci: _Optional[bytes] = ..., wasApproved: _Optional[bool] = ...) -> None: ...
...
class GroupInviteLinkEnabledUpdate(_message.Message):
    ...
    def __init__(self, updaterAci: _Optional[bytes] = ..., linkRequiresAdminApproval: _Optional[bool] = ...) -> None: ...
...
class GroupTerminateChangeUpdate(_message.Message):
    __slots__ = ("updaterAci",)
    UPDATERACI_FIELD_NUMBER: _ClassVar[int]
    updaterAci: bytes
    def __init__(self, updaterAci: _Optional[bytes] = ...) -> None: ...

class PollTerminateUpdate(_message.Message):
    __slots__ = ("targetSentTimestamp", "question")
    TARGETSENTTIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    QUESTION_FIELD_NUMBER: _ClassVar[int]
    targetSentTimestamp: int
    question: str
    def __init__(self, targetSentTimestamp: _Optional[int] = ..., question: _Optional[str] = ...) -> None: ...

class PinMessageUpdate(_message.Message):
    __slots__ = ("targetSentTimestamp", "authorId")
    TARGETSENTTIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    AUTHORID_FIELD_NUMBER: _ClassVar[int]
    targetSentTimestamp: int
    authorId: int
    def __init__(self, targetSentTimestamp: _Optional[int] = ..., authorId: _Optional[int] = ...) -> None: ...
...
class ChatStyle(_message.Message):
    ...
    def __init__(self, wallpaperPreset: _Optional[_Union[ChatStyle.WallpaperPreset, str]] = ..., wallpaperPhoto: _Optional[_Union[FilePointer, _Mapping]] = ..., autoBubbleColor: _Optional[_Union[ChatStyle.AutomaticBubbleColor, _Mapping]] = ..., bubbleColorPreset: _Optional[_Union[ChatStyle.BubbleColorPreset, str]] = ..., customColorId: _Optional[int] = ..., dimWallpaperInDarkMode: _Optional[bool] = ...) -> None: ...
...
class ChatFolder(_message.Message):
    ...
    id: bytes
    def __init__(self, name: _Optional[str] = ..., showOnlyUnread: _Optional[bool] = ..., showMutedChats: _Optional[bool] = ..., includeAllIndividualChats: _Optional[bool] = ..., includeAllGroupChats: _Optional[bool] = ..., folderType: _Optional[_Union[ChatFolder.FolderType, str]] = ..., includedRecipientIds: _Optional[_Iterable[int]] = ..., excludedRecipientIds: _Optional[_Iterable[int]] = ..., id: _Optional[bytes] = ...) -> None: ...
